...
public class OpposingGrid extends JPanel {
	 ...
	 public static final Color NOT_DICOVERED = new Color(255,20,20);
	 public static final Color TOUCHED = new Color(25,20,250);
	 public static final Color NOT_TOUCHED = new Color(25,250,20);
